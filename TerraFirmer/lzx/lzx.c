...
int LZXdecompress(struct LZXstate *pState, const unsigned char *inpos, unsigned char *outpos, int inlen, int outlen) {
    const UBYTE *endinp = inpos + inlen;
